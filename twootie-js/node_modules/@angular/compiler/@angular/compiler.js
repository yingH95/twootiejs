                    ...
                    if (expression['__symbolic']) {
                        ...
                        switch (expression['__symbolic']) {
                            ...
                            case 'error':
                                ...
                                if (expression['lines']) {
                                    message =
                                        `${message} (position ${expression['lines'] + 1}:${expression['character'] + 1} in the original .ts file)`;
                                    self.reportError(positionalError(message, context.filePath, expression['lines'], expression['character']), context);
                                }
                                else {
